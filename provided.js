...
function createCardsTest() {
  ...
  if (cards.length !== 12) {
    if (!passedStep2cHeuristics) {
      ...
      console.error(`${TEST_NAME} should return 12 card objects as children but got ${parent.children.length}. Make sure you are pushing 12 cards onto your cards array!`);
    }
    return false;
  }
